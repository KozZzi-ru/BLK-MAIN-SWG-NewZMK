...
- На базовом слое (QWERTY): вертикальный скролл - обычная скорость (1:1), горизонтальный - в 4 раза медленнее (1:4)
- На слое NUM_AND_FUN: вертикальный скролл - обычная скорость (1:1), горизонтальный - в 4 раза медленнее (1:4)
